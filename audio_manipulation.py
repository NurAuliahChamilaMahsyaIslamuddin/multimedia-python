...
def manipulate_audio(input_path, output_path):
    try:
        ...
        # Operasi Pengaturan Volume dengan fallback
        if audio.dBFS < -10:
            louder_audio = audio + 10  # Meningkatkan volume sebesar 10dB
            print("✅ Volume ditingkatkan sebesar 10 dB")
        else:
            # Jika volume sudah tinggi, tetap menggunakan audio asli tanpa mengubah volume
            louder_audio = audio
            print("🔈 Volume audio tetap, tidak dilakukan peningkatan")
